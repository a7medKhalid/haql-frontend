...
export const Newspaper = ({ classname = '' }) => (
    <svg
        className={`w-4 h-4 ${classname}`}
        fill="none"
        stroke="currentColor"
...
export const UsersGroup = ({ classname = '' }) => {
    return (
        <svg
            className={`w-4 h-4 ${classname}`}
            fill="none"
...
export const ShareLink = ({ classname = '' }) => {
    return (
        <svg
            className={`w-4 h-4 ${classname}`}
            fill="none"
...
export const ChevronDoubleIcon = ({ classname = '' }) => {
    return (
        <svg
            className={`w-4 h-4 ${classname}`}
            fill="none"
